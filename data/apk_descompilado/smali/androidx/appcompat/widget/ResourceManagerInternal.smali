...
.method public static declared-synchronized getPorterDuffColorFilter(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    .line 493
    .restart local v1    # "filter":Landroid/graphics/PorterDuffColorFilter;
    .restart local p0    # "color":I
    .restart local p1    # "mode":Landroid/graphics/PorterDuff$Mode;
    :cond_0
    :goto_0
    monitor-exit v0
...
.method public final declared-synchronized addDrawableToCache(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    .restart local v1    # "cache":Landroidx/collection/LongSparseArray;, "Landroidx/collection/LongSparseArray<Ljava/lang/ref/WeakReference<Landroid/graphics/drawable/Drawable$ConstantState;>;>;"
    .restart local p1    # "context":Landroid/content/Context;
    .restart local p2    # "key":J
...
.method public final createDrawableIfNeeded(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 192
    invoke-virtual {p0, p1, v1, v2, v4}, Landroidx/appcompat/widget/ResourceManagerInternal;->addDrawableToCache(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method public final declared-synchronized getCachedDrawable(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    .restart local v3    # "entry":Landroid/graphics/drawable/Drawable$ConstantState;
    .restart local p1    # "context":Landroid/content/Context;
    .restart local p2    # "key":J
    :cond_1
    :try_start_2
...
.method public declared-synchronized getDrawable(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .restart local p3    # "failIfNotKnown":Z
    :cond_0
    :goto_0
    if-nez v0, :cond_1
...
.method public final loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .restart local v9    # "delegate":Landroidx/appcompat/widget/ResourceManagerInternal$InflateDelegate;
...
.method public declared-synchronized onDrawableLoadedFromResources(Landroid/content/Context;Landroidx/appcompat/widget/VectorEnabledTintResources;I)Landroid/graphics/drawable/Drawable;
    ...
    .restart local v0    # "drawable":Landroid/graphics/drawable/Drawable;
    .restart local p1    # "context":Landroid/content/Context;
    .restart local p2    # "resources":Landroidx/appcompat/widget/VectorEnabledTintResources;
